// ==UserScript==
// @name        Spotify Lyrics+ With Playback Control
...
function timeoutPromise(ms) {
  ...
  // Helper to simulate clicks on Spotify Web Player buttons by class or aria-label
  function sendSpotifyCommand(command) {
    let selector;
    switch (command) {
      case "playpause":
        selector = '[aria-label="Pause"], [aria-label="Play"]';
        break;
      case "next":
