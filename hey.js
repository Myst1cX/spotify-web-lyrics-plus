...
// Track user opening/closing NPV
document.addEventListener('click', function(e) {
    ...
    // Block synthetic (non-trusted) opens
    if (openBtn && !e.isTrusted) {
...
// Close NPV if NOT user-initiated
function closeNPV() {
...
// Unique MutationObserver for NPV only!
...
// On page load, ensure NPV is closed unless user-initiated
setTimeout(() => {
    const npv = document.querySelector(NPV_VIEW_SELECTOR);
    if (npv && npv.offsetParent !== null && !userOpenedNPV) {
        closeNPV();
