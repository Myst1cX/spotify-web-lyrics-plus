...
> 5. **Chinese Conversion via open.cc (now using full.js instead of only t2cn.js) from** [holsoma/Spotify Lyrics: Trad ⇄ Simplified (version 1.0.0)](https://greasyfork.org/en/scripts/555411-spotify-lyrics-trad-simplified)
