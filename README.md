...
> <img src="icons/header/reset.svg" width="16" height="16" align="absmiddle" alt="reset icon"/> Reset button to restore default popup position/size.
> 
> **FONT SIZE PICKER**  
...
> Show/hide translation controls using the <img src="icons/header/translate.svg" width="16" height="16" align="absmiddle" alt="translate icon"/> translate icon button. 
>
> **TRANSLITERATION**  
...
> Can be toggled on/off using the <img src="icons/header/pip.svg" width="16" height="16" align="absmiddle" alt="PiP icon"/> dedicated PiP icon button (styled to match Spotify's own native Picture-in-Picture icon).  
...
> 8. **Settings panel:** Click the <img src="icons/header/settings.svg" width="16" height="16" align="absmiddle" alt="settings icon"/> settings icon button to open/close the settings panel (show/hide lyric source tabs, show/hide seekbar, show/hide playback controls, set timing offset, enable/disable AMOLED theme).   
> 5. **Translate lyrics:** Click the <img src="icons/header/translate.svg" width="16" height="16" align="absmiddle" alt="translate icon"/> translate icon button to toggle translation controls, pick your language, and press on "Translate".  
...
> 9. **Reset:** Click the <img src="icons/header/reset.svg" width="16" height="16" align="absmiddle" alt="reset icon"/> reset icon button to restore default popup position/size.  
