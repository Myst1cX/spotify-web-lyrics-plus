...
> 9. **Reset:** Click the <img src="icons/header/reset.svg" width="16" height="16" align="absmiddle" alt="reset icon"/> reset button to restore default popup position/size.  
