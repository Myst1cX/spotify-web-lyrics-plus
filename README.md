...
> Supports **synced & unsynced lyrics** from multiple providers, **adjusting the lyric offset**, **live translation**, **playback controls**, **seekbar**, **lyrics download**, **transliteration**, **Chinese script conversion**, **AMOLED theme** and more.  
...
> Note: You can paste the full Authorization header value (including the "Bearer " prefix) - it will be stripped automatically.
